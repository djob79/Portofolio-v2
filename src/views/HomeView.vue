<template>
  <main
    ...
    <p class="text-amber-200">WhosFrench</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">WhosFrench</h1>
      <div class="py-2">
        <h1
      ...
      <p class="text-white pr-4 fade-in-from-left">Welcome to My personal website. <span class="fire">🔥</span></p>
      <br>
      <!-- <button
...
export default {
  ...
  data() {
    return {
      toRotate: ["Discord Bot Developer", "Luau advancee.", "Informatics Student", "Tech Enthusiast"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
