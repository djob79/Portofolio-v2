  ...
  data() {
    return {
      ...
      items: [
        {
          id: 1,
          name: 'WhosFrench Millitary / WhosFrench British Army',
          imageUrl: 'noFilte.webp',
          status: 'Still up - Sandhurt copy/Made. I tried making it look as realistic and look like sandhurst british army.',
          tech: 'Luau',
          github: '',
          demo: 'https://www.roblox.com/games/130288944902919/WhosFrench-British-Army'
        }
      ]
    };
  }
            ...
            <div v-for="item in items" :key="item.id">
              <div
                ...
                <div class="flex h-12 w-12 items-center justify-center p-0 h-full w-full lg:p-0 zoom-in">
                  <img alt="Luau" loading="lazy" decoding="async" data-nimg="1" class="drop-shadow-xl rounded rounded-xl"
